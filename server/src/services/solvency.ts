 ...
 *
 * That ceiling is OPTIONAL and off by default (migration 018): how much a drop
...
export interface Controls {
   ...
   * `null` for no ceiling — which is the default since migration 018. See
 ...
 *
 * THE TWO LINES ARE NOT THE SAME KIND OF THING, and migration 018 turned the
 ...
 *    is the sponsor's decision (migration 018), and what the deployment can
